...
public class Finding {
    ...
    private List<Document> relatedFindingsRef;
    ...
    public List<Document> getRelatedFindingsRef() { return relatedFindingsRef; }
    @JsonProperty("relatedFindingsRef")
    public void setRelatedFindingsRef(List<Document> value) { this.relatedFindingsRef = value; }
