...
public class XformEksClusterProcessor extends XformAwsProcessor {
	...
	public List<XformEksCluster> getXformObject() throws IOException {
		...
		for(Cluster cluster: clusterList) {
			...
			Optional<VpcConfigResponse> resourcesVpcConfig = cluster.getValueForField("resourcesVpcConfig", VpcConfigResponse.class);
			Optional<KubernetesNetworkConfigResponse> kubernetesNetworkConfig = cluster.getValueForField("kubernetesNetworkConfig", KubernetesNetworkConfigResponse.class);
			...
			Optional<Certificate> certificateAuthority = cluster.getValueForField("certificateAuthority", Certificate.class);
