...
public class Finding implements Serializable{
    ...
    private List<RelatedFindingsRef> relatedFindingsRef;
    ...
    public List<RelatedFindingsRef> getRelatedFindingsRef() { return relatedFindingsRef; }
    @JsonProperty("relatedFindingsRef")
    public void setRelatedFindingsRef(List<RelatedFindingsRef> value) { this.relatedFindingsRef = value; }
