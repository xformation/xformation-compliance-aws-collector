...
public class ResourcesVpcConfig implements Serializable {
	...
	@JsonProperty("endpointPrivateAccess")
	public void setEndpointPrivateAccess(Boolean value) {
	...
	@JsonProperty("endpointPublicAccess")
	public void setEndpointPublicAccess(Boolean value) {
		this.endpointPublicAccess = value;
	}

	@JsonProperty("publicAccessCidrs")
	public PublicAccessCIDR[] getPublicAccessCidrs() {
		return publicAccessCidrs;
	}

	@JsonProperty("publicAccessCidrs")
	public void setPublicAccessCidrs(PublicAccessCIDR[] value) {
		this.publicAccessCidrs = value;
	}

	@JsonProperty("additionalSecurityGroups")
	public SecurityGroup[] getAdditionalSecurityGroups() {
		return additionalSecurityGroups;
	}

	@JsonProperty("additionalSecurityGroups")
	public void setAdditionalSecurityGroups(SecurityGroup[] value) {
		this.additionalSecurityGroups = value;
	}
	...
	@JsonProperty("clusterSecurityGroup")
	public void setClusterSecurityGroup(SecurityGroup value) {
		this.clusterSecurityGroup = value;
	}

	@JsonProperty("subnetIds")
	public PublicAccessCIDR[] getSubnetIDS() {
		return subnetIDS;
	}

	@JsonProperty("subnetIds")
	public void setSubnetIDS(PublicAccessCIDR[] value) {
