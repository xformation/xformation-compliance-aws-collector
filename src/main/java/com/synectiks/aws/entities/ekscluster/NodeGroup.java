...
public class NodeGroup implements Serializable {
    ...
    @JsonProperty("nodegroupName")
    public void setNodegroupName(String value) { this.nodegroupName = value; }
    ...
    @JsonProperty("health")
    public void setHealth(Health value) { this.health = value; }
    ...
    @JsonProperty("nodeRole")
    public void setNodeRole(String value) { this.nodeRole = value; }

    @JsonProperty("nodegroupArn")
    public String getNodegroupArn() { return nodegroupArn; }
    @JsonProperty("nodegroupArn")
    public void setNodegroupArn(String value) { this.nodegroupArn = value; }
    ...
    @JsonProperty("amiType")
    public void setAmiType(String value) { this.amiType = value; }

    @JsonProperty("diskSize")
    public String getDiskSize() { return diskSize; }
    @JsonProperty("diskSize")
    public void setDiskSize(String value) { this.diskSize = value; }

    @JsonProperty("scalingConfig")
    public ScalingConfig getScalingConfig() { return scalingConfig; }
    @JsonProperty("scalingConfig")
    public void setScalingConfig(ScalingConfig value) { this.scalingConfig = value; }

    @JsonProperty("resources")
    public Resources getResources() { return resources; }
    @JsonProperty("resources")
    public void setResources(Resources value) { this.resources = value; }

    @JsonProperty("remoteAccess")
    public RemoteAccess getRemoteAccess() { return remoteAccess; }
    @JsonProperty("remoteAccess")
    public void setRemoteAccess(RemoteAccess value) { this.remoteAccess = value; }

    @JsonProperty("instanceTypes")
    public PublicAccessCIDR[] getInstanceTypes() { return instanceTypes; }
    @JsonProperty("instanceTypes")
    public void setInstanceTypes(PublicAccessCIDR[] value) { this.instanceTypes = value; }
    ...
    @JsonProperty("labels")
    public Tag[] getLabels() { return labels; }
    @JsonProperty("labels")
    public void setLabels(Tag[] value) { this.labels = value; }
