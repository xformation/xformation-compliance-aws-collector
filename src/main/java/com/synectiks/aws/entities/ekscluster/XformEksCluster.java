...
public class XformEksCluster implements Serializable {
    ...
    @JsonProperty("roleArn")
    public void setRoleArn(String value) { this.roleArn = value; }
    ...
    @JsonProperty("resourcesVpcConfig")
    public void setResourcesVpcConfig(ResourcesVpcConfig value) { this.resourcesVpcConfig = value; }

    @JsonProperty("nodeGroups")
    public NodeGroup[] getNodeGroups() { return nodeGroups; }
    @JsonProperty("nodeGroups")
    public void setNodeGroups(NodeGroup[] value) { this.nodeGroups = value; }

    @JsonProperty("fargateProfiles")
    public FargateProfile[] getFargateProfiles() { return fargateProfiles; }
    @JsonProperty("fargateProfiles")
    public void setFargateProfiles(FargateProfile[] value) { this.fargateProfiles = value; }
    ...
    public KubernetesNetworkConfigResponse getKubernetesNetworkConfig() { return kubernetesNetworkConfig; }
    @JsonProperty("kubernetesNetworkConfig")
    public void setKubernetesNetworkConfig(KubernetesNetworkConfigResponse value) { this.kubernetesNetworkConfig = value; }
    
    @JsonProperty("certificateAuthority")
    public Certificate getCertificateAuthority() { return certificateAuthority; }
    @JsonProperty("certificateAuthority")
    public void setCertificateAuthority(Certificate value) {this.certificateAuthority = value; }
    
    @JsonProperty("clientRequestToken")
    public String getClientRequestToken() { return clientRequestToken; }
    @JsonProperty("clientRequestToken")
    public void setClientRequestToken(String value) { this.clientRequestToken = value; }
    ...
    @JsonProperty("encryptionConfig")
    public void setEncryptionConfig(List<EncryptionConfig> value) { this.encryptionConfig = value; }
