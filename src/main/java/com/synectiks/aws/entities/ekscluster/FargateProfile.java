...
public class FargateProfile implements Serializable {
	...
	@JsonProperty("fargateProfileArn")
	public void setFargateProfileArn(String value) {
		this.fargateProfileArn = value;
	}
	...
	@JsonProperty("fargateProfileName")
	public void setFargateProfileName(String value) {
	...
	@JsonProperty("podExecutionRoleArn")
	public void setPodExecutionRoleArn(String value) {
	...
	@JsonProperty("selectors")
	public void setSelectors(Selector[] value) {
