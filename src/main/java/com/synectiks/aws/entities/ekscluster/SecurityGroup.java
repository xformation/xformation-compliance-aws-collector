...
public class SecurityGroup implements Serializable {
	...
	public BoundRule[] getInboundRules() {
		return inboundRules;
	}

	@JsonProperty("inboundRules")
	public void setInboundRules(BoundRule[] value) {
		this.inboundRules = value;
	}

	@JsonProperty("outboundRules")
	public BoundRule[] getOutboundRules() {
		return outboundRules;
	}

	@JsonProperty("outboundRules")
	public void setOutboundRules(BoundRule[] value) {
