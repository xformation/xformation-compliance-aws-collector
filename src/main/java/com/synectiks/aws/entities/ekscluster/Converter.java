...
public class Converter {
	...
	public static XformEksCluster fromJsonString(String json) throws IOException {
	...
	private static void instantiateMapper() {
		...
		reader = mapper.readerFor(XformEksCluster.class);
		writer = mapper.writerFor(XformEksCluster.class);
	}
