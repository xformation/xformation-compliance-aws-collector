...
public class RemoteAccess implements Serializable {
    ...
    public String getEc2SSHKey() { return ec2SSHKey; }
    @JsonProperty("ec2SshKey")
    public void setEc2SSHKey(String value) { this.ec2SSHKey = value; }

    @JsonProperty("sourceSecurityGroups")
    public PublicAccessCIDR[] getSourceSecurityGroups() { return sourceSecurityGroups; }
    @JsonProperty("sourceSecurityGroups")
    public void setSourceSecurityGroups(PublicAccessCIDR[] value) { this.sourceSecurityGroups = value; }
