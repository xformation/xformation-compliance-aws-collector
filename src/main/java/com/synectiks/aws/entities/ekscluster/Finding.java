...
public class Finding implements Serializable {
	...
	public PublicAccessCIDR[] getRelatedFindingsRef() {
		return relatedFindingsRef;
	}

	@JsonProperty("relatedFindingsRef")
	public void setRelatedFindingsRef(PublicAccessCIDR[] value) {
	...
	@JsonProperty("additionalFields")
	public void setAdditionalFields(AdditionalField[] value) {
