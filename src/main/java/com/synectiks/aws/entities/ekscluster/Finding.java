...
public class Finding implements Serializable {
    ...
    private PublicAccessCIDR[] relatedFindingsRef;
    ...
    public String getFindingSeverity() { return findingSeverity; }
    @JsonProperty("findingSeverity")
    public void setFindingSeverity(String value) { this.findingSeverity = value; }

    @JsonProperty("originalFindingSeverity")
    public String getOriginalFindingSeverity() { return originalFindingSeverity; }
    @JsonProperty("originalFindingSeverity")
    public void setOriginalFindingSeverity(String value) { this.originalFindingSeverity = value; }
    ...
    public String getFindingSourceURL() { return findingSourceURL; }
    @JsonProperty("findingSourceUrl")
    public void setFindingSourceURL(String value) { this.findingSourceURL = value; }
    ...
    public String getFindingSource() { return findingSource; }
    @JsonProperty("findingSource")
    public void setFindingSource(String value) { this.findingSource = value; }

    @JsonProperty("findingSourceDescription")
    public String getFindingSourceDescription() { return findingSourceDescription; }
    @JsonProperty("findingSourceDescription")
    public void setFindingSourceDescription(String value) { this.findingSourceDescription = value; }
    ...
    public String getFindingCreatedAt() { return findingCreatedAt; }
    @JsonProperty("findingCreatedAt")
    public void setFindingCreatedAt(String value) { this.findingCreatedAt = value; }
    ...
    @JsonProperty("findingDescription")
    public void setFindingDescription(String value) { this.findingDescription = value; }

    @JsonProperty("findingStatus")
    public String getFindingStatus() { return findingStatus; }
    @JsonProperty("findingStatus")
    public void setFindingStatus(String value) { this.findingStatus = value; }

    @JsonProperty("findingRecommendation")
    public String getFindingRecommendation() { return findingRecommendation; }
    @JsonProperty("findingRecommendation")
    public void setFindingRecommendation(String value) { this.findingRecommendation = value; }

    @JsonProperty("findingCategory")
    public String getFindingCategory() { return findingCategory; }
    @JsonProperty("findingCategory")
    public void setFindingCategory(String value) { this.findingCategory = value; }

    @JsonProperty("relatedFindingsRef")
    public PublicAccessCIDR[] getRelatedFindingsRef() { return relatedFindingsRef; }
    @JsonProperty("relatedFindingsRef")
    public void setRelatedFindingsRef(PublicAccessCIDR[] value) { this.relatedFindingsRef = value; }
    ...
    public FindingRulesPackage getFindingRulesPackage() { return findingRulesPackage; }
    @JsonProperty("findingRulesPackage")
	...
	public String toString() {
		return "Finding [receivedTimeStamp=" + receivedTimeStamp + ", findingSeverity=" + findingSeverity
				...
				+ findingCategory + ", relatedFindingsRef=" + Arrays.toString(relatedFindingsRef) + ", ruleID=" + ruleID
				+ ", findingRulesPackage=" + findingRulesPackage + ", additionalFields="
				+ Arrays.toString(additionalFields) + "]";
	}
}
