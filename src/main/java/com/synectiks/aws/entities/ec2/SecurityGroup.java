...
public class SecurityGroup implements Serializable{
    ...
    public List<AssumeRolePolicy> getInboundPrefixes() { return inboundPrefixes; }
    @JsonProperty("inboundPrefixes")
    public void setInboundPrefixes(List<AssumeRolePolicy> value) { this.inboundPrefixes = value; }

    @JsonProperty("outboundPrefixes")
    public List<AssumeRolePolicy> getOutboundPrefixes() { return outboundPrefixes; }
    @JsonProperty("outboundPrefixes")
    public void setOutboundPrefixes(List<AssumeRolePolicy> value) { this.outboundPrefixes = value; }
