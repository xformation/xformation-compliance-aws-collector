...
public class AssociationOverview implements Serializable{
    ...
    public List<Tag> getInstanceAssociationStatusAggregatedCount() { return instanceAssociationStatusAggregatedCount; }
    @JsonProperty("instanceAssociationStatusAggregatedCount")
    public void setInstanceAssociationStatusAggregatedCount(List<Tag> value) { this.instanceAssociationStatusAggregatedCount = value; }
	@Override
