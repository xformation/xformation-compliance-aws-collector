...
public class ExternalFindingsFinding {
    ...
    public List<AssumeRolePolicy> getRelatedFindingsRef() { return relatedFindingsRef; }
    @JsonProperty("relatedFindingsRef")
    public void setRelatedFindingsRef(List<AssumeRolePolicy> value) { this.relatedFindingsRef = value; }
    ...
    public RulesPackage getFindingRulesPackage() { return findingRulesPackage; }
    @JsonProperty("findingRulesPackage")
    public void setFindingRulesPackage(RulesPackage value) { this.findingRulesPackage = value; }
