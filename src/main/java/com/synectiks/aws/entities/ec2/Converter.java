...
public class Converter {
	...
	public static CustomInstance fromJsonString(String json) throws IOException {
		return getObjectReader().readValue(json);
	}

	public static String toJsonString(CustomInstance obj) throws JsonProcessingException {
	...
	private static void instantiateMapper() {
		...
		reader = mapper.readerFor(CustomInstance.class);
		writer = mapper.writerFor(CustomInstance.class);
	}
