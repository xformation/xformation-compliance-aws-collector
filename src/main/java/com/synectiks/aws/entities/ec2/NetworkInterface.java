...
public class NetworkInterface implements Serializable{
    ...
    private List<AssumeRolePolicy> ipv6Addresses;
    ...
    @JsonProperty("attachment")
    public void setAttachment(NetworkInterfaceAttachment value) { this.attachment = value; }
    ...
    @JsonProperty("interfaceType")
    public void setInterfaceType(String value) { this.interfaceType = value; }

    @JsonProperty("ipv6Addresses")
    public List<AssumeRolePolicy> getIpv6Addresses() { return ipv6Addresses; }
    @JsonProperty("ipv6Addresses")
    public void setIpv6Addresses(List<AssumeRolePolicy> value) { this.ipv6Addresses = value; }
    ...
    public List<PrivateIPAddress> getPrivateIPAddresses() { return privateIPAddresses; }
    @JsonProperty("privateIpAddresses")
    public void setPrivateIPAddresses(List<PrivateIPAddress> value) { this.privateIPAddresses = value; }

    @JsonProperty("requesterId")
    public String getRequesterID() { return requesterID; }
    @JsonProperty("requesterId")
    public void setRequesterID(String value) { this.requesterID = value; }

    @JsonProperty("requesterManaged")
    public String getRequesterManaged() { return requesterManaged; }
    @JsonProperty("requesterManaged")
    public void setRequesterManaged(String value) { this.requesterManaged = value; }

    @JsonProperty("sourceDestCheck")
    public String getSourceDestCheck() { return sourceDestCheck; }
    @JsonProperty("sourceDestCheck")
    public void setSourceDestCheck(String value) { this.sourceDestCheck = value; }
