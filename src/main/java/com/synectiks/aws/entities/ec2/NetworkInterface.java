...
public class NetworkInterface implements Serializable {
	...
	@JsonProperty("attachment")
	public void setAttachment(NetworkInterfaceAttachment value) {
	...
	public List<AssumeRolePolicy> getIpv6Addresses() {
		return ipv6Addresses;
	}

	@JsonProperty("ipv6Addresses")
	public void setIpv6Addresses(List<AssumeRolePolicy> value) {
