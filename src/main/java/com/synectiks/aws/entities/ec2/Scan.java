...
public class Scan {
	...
	@JsonProperty("rulesPackages")
	public void setRulesPackages(List<RulesPackage> value) {
		this.rulesPackages = value;
	}

	@JsonProperty("findingsCount")
	public FindingsCount getFindingsCount() {
		return findingsCount;
	}

	@JsonProperty("findingsCount")
	public void setFindingsCount(FindingsCount value) {
		this.findingsCount = value;
	}
	...
	public AssumeRolePolicy getSourceAdditionalFields() {
		return sourceAdditionalFields;
	}

	@JsonProperty("sourceAdditionalFields")
	public void setSourceAdditionalFields(AssumeRolePolicy value) {
		this.sourceAdditionalFields = value;
	}
}
