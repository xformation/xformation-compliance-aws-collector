...
public class DirectConnectVirtualInterface implements Serializable{
    ...
    private List<AssumeRolePolicy> routeFilterPrefixes;
    ...
    public List<AssumeRolePolicy> getRouteFilterPrefixes() { return routeFilterPrefixes; }
    @JsonProperty("routeFilterPrefixes")
    public void setRouteFilterPrefixes(List<AssumeRolePolicy> value) { this.routeFilterPrefixes = value; }
