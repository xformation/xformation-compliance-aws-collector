...
public class XformEc2 implements Serializable{
    ...
    @JsonProperty("launchTime")
    public void setLaunchTime(Instant value) { this.launchTime = value; }
    ...
    public Integer getAmiLaunchIndex() { return amiLaunchIndex; }
    @JsonProperty("amiLaunchIndex")
    public void setAmiLaunchIndex(Integer value) { this.amiLaunchIndex = value; }
    ...
    @JsonProperty("placement")
    public void setPlacement(Placement value) { this.placement = value; }
    ...
    @JsonProperty("productCodes")
    public void setProductCodes(List value) { this.productCodes = value; }
    ...
    @JsonProperty("state")
    public void setState(InstanceState value) { this.state = value; }
    
    @JsonProperty("stateTransitionReason")
    public String getStateTransitionReason() { return stateTransitionReason; }
    @JsonProperty("stateTransitionReason")
    public void setStateTransitionReason(String value) { this.stateTransitionReason = value; }
    ...
    public List getBlockDeviceMappings() { return blockDeviceMappings; }
    @JsonProperty("blockDeviceMappings")
    public void setBlockDeviceMappings(List value) { this.blockDeviceMappings = value; }
    
    @JsonProperty("clientToken")
    public String getClientToken() { return clientToken; }
    @JsonProperty("clientToken")
    public void setClientToken(String value) { this.clientToken = value; }
    
    @JsonProperty("ebsOptimized")
    public Boolean getEbsOptimized() { return ebsOptimized; }
    @JsonProperty("ebsOptimized")
    public void setEbsOptimized(Boolean value) { this.ebsOptimized = value; }
    
    @JsonProperty("enaSupport")
    public Boolean getEnaSupport() { return enaSupport; }
    @JsonProperty("enaSupport")
    public void setEnaSupport(Boolean value) { this.enaSupport = value; }
    ...
    @JsonProperty("iamInstanceProfile")
    public void setIamInstanceProfile(IamInstanceProfile value) { this.iamInstanceProfile = value; }
    
    @JsonProperty("instanceLifecycle")
    public String getInstanceLifecycle() { return instanceLifecycle; }
    @JsonProperty("instanceLifecycle")
    public void setInstanceLifecycle(String value) { this.instanceLifecycle = value; }
    
    @JsonProperty("elasticGpuAssociations")
    public List getElasticGpuAssociations() { return elasticGpuAssociations; }
    @JsonProperty("elasticGpuAssociations")
    public void setElasticGpuAssociations(List value) { this.elasticGpuAssociations = value; }
    
    @JsonProperty("elasticInferenceAcceleratorAssociations")
    public List getElasticInferenceAcceleratorAssociations() { return elasticInferenceAcceleratorAssociations; }
    @JsonProperty("elasticInferenceAcceleratorAssociations")
    public void setElasticInferenceAcceleratorAssociations(List value) { this.elasticInferenceAcceleratorAssociations = value; }
    
    @JsonProperty("networkInterfaces")
    public List getNetworkInterfaces() { return networkInterfaces; }
    @JsonProperty("networkInterfaces")
    public void setNetworkInterfaces(List value) { this.networkInterfaces = value; }
   
    @JsonProperty("outpostArn")
    public String getOutpostArn() { return outpostArn; }
    @JsonProperty("outpostArn")
    public void setOutpostArn(String value) { this.outpostArn = value; }
    ...
    @JsonProperty("securityGroups")
    public void setSecurityGroups(List value) { this.securityGroups = value; }
    
	@JsonProperty("sourceDestCheck")
    public Boolean getSourceDestCheck() { return sourceDestCheck; }
    @JsonProperty("sourceDestCheck")
    public void setSourceDestCheck(Boolean value) { this.sourceDestCheck = value; }
    
	@JsonProperty("spotInstanceRequestId")
    public String getSpotInstanceRequestId() { return spotInstanceRequestId; }
    @JsonProperty("spotInstanceRequestId")
    public void setSpotInstanceRequestId(String value) { this.spotInstanceRequestId = value; }
    ...
    @JsonProperty("cpuOptions")
    public void setCpuOptions(CpuOptions value) { this.cpuOptions = value; }
   
	@JsonProperty("capacityReservationId")
    public String getCapacityReservationId() { return capacityReservationId; }
    @JsonProperty("capacityReservationId")
    public void setCapacityReservationId(String value) { this.capacityReservationId = value; }
   
	
	@JsonProperty("capacityReservationSpecification")
    public CapacityReservationSpecificationResponse getCapacityReservationSpecification() { return capacityReservationSpecification; }
    @JsonProperty("capacityReservationSpecification")
    public void setCapacityReservationSpecification(CapacityReservationSpecificationResponse value) { this.capacityReservationSpecification = value; }
   
	
	@JsonProperty("hibernationOptions")
    public HibernationOptions getHibernationOptions() { return hibernationOptions; }
    @JsonProperty("hibernationOptions")
    public void setHibernationOptions(HibernationOptions value) { this.hibernationOptions = value; }
   
	
	@JsonProperty("licenses")
    public List getLicenses() { return licenses; }
    @JsonProperty("licenses")
    public void setLicenses(List value) { this.licenses = value; }
   
	
	@JsonProperty("metadataOptions")
    public InstanceMetadataOptionsResponse getMetadataOptions() { return metadataOptions; }
    @JsonProperty("metadataOptions")
    public void setMetadataOptions(InstanceMetadataOptionsResponse value) { this.metadataOptions = value; }
   
    @JsonProperty("enclaveOptions")
    public EnclaveOptions getEnclaveOptions() { return enclaveOptions; }
    @JsonProperty("enclaveOptions")
    public void setEnclaveOptions(EnclaveOptions value) { this.enclaveOptions = value; }
   
	@JsonProperty("bootMode")
    public String getBootMode() { return bootMode; }
    @JsonProperty("bootMode")
    public void setBootMode(String value) { this.bootMode = value; }
	...
	public String toString() {
		return "Welcome [image=" + image + ", imageDetails=" + imageDetails + ", kernelID=" + kernelID + ", platform="
				...
				+ ", name=" + name + ", accountNumber=" + accountNumber + ", region=" + region
