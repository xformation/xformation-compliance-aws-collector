...
public class EncryptionKey {
    ...
    @JsonProperty("awsAccountId")
    public void setAwsAccountID(String value) { this.awsAccountID = value; }
    ...
    public String getDeletionDate() { return deletionDate; }
    @JsonProperty("deletionDate")
    public void setDeletionDate(String value) { this.deletionDate = value; }
    ...
    @JsonProperty("expirationModel")
    public void setExpirationModel(String value) { this.expirationModel = value; }

    @JsonProperty("keyState")
    public String getKeyState() { return keyState; }
    @JsonProperty("keyState")
    public void setKeyState(String value) { this.keyState = value; }

    @JsonProperty("keyUsage")
    public String getKeyUsage() { return keyUsage; }
    @JsonProperty("keyUsage")
    public void setKeyUsage(String value) { this.keyUsage = value; }
    ...
    @JsonProperty("customerMasterKeySpec")
    public void setCustomerMasterKeySpec(String value) { this.customerMasterKeySpec = value; }

    @JsonProperty("isSymmetricKey")
    public String getIsSymmetricKey() { return isSymmetricKey; }
    @JsonProperty("isSymmetricKey")
    public void setIsSymmetricKey(String value) { this.isSymmetricKey = value; }

    @JsonProperty("keyManager")
    public String getKeyManager() { return keyManager; }
    @JsonProperty("keyManager")
    public void setKeyManager(String value) { this.keyManager = value; }

    @JsonProperty("aliases")
    public List<ManagedPolicy> getAliases() { return aliases; }
    @JsonProperty("aliases")
    public void setAliases(List<ManagedPolicy> value) { this.aliases = value; }

    @JsonProperty("isCustomerManaged")
    public String getIsCustomerManaged() { return isCustomerManaged; }
    @JsonProperty("isCustomerManaged")
    public void setIsCustomerManaged(String value) { this.isCustomerManaged = value; }

    @JsonProperty("rotationStatus")
    public String getRotationStatus() { return rotationStatus; }
    @JsonProperty("rotationStatus")
    public void setRotationStatus(String value) { this.rotationStatus = value; }

    @JsonProperty("policies")
    public List<Policy> getPolicies() { return policies; }
    @JsonProperty("policies")
    public void setPolicies(List<Policy> value) { this.policies = value; }

    @JsonProperty("kmsAssetsStats")
    public List<AssetsStat> getKmsAssetsStats() { return kmsAssetsStats; }
    @JsonProperty("kmsAssetsStats")
    public void setKmsAssetsStats(List<AssetsStat> value) { this.kmsAssetsStats = value; }
