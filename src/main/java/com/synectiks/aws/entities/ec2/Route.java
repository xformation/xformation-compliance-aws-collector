...
public class Route {
	...
	@JsonProperty("destinationIpv6CidrBlock")
	public void setDestinationIpv6CIDRBlock(String value) {
	...
	@JsonProperty("destinationPrefixListId")
	public void setDestinationPrefixListID(String value) {
	...
	@JsonProperty("egressOnlyInternetGatewayId")
	public void setEgressOnlyInternetGatewayID(String value) {
	...
	@JsonProperty("natGatewayId")
	public void setNatGatewayID(String value) {
