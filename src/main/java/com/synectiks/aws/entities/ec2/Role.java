...
public class Role implements Serializable{
    ...
    public AssumeRolePolicy getAssumeRolePolicy() { return assumeRolePolicy; }
    @JsonProperty("assumeRolePolicy")
    public void setAssumeRolePolicy(AssumeRolePolicy value) { this.assumeRolePolicy = value; }
    ...
    public List<Policy> getInlinePolicies() { return inlinePolicies; }
    @JsonProperty("inlinePolicies")
    public void setInlinePolicies(List<Policy> value) { this.inlinePolicies = value; }
