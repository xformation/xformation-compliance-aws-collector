...
public class Options {
	...
	public String toString() {
		return "Options [amazonSideAsn=" + amazonSideAsn + ", associationDefaultRouteTableID="
				+ associationDefaultRouteTableID + ", autoAcceptSharedAttachments=" + autoAcceptSharedAttachments
				+ ", defaultRouteTableAssociation=" + defaultRouteTableAssociation + ", defaultRouteTablePropagation="
				+ defaultRouteTablePropagation + ", dnsSupport=" + dnsSupport + ", propagationDefaultRouteTableID="
				+ propagationDefaultRouteTableID + ", vpnEcmpSupport=" + vpnEcmpSupport + "]";
	}
}
