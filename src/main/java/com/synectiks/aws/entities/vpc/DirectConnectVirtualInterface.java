...
public class DirectConnectVirtualInterface implements Serializable {
	...
	public BGPPeer[] getBGPPeers() {
		return bgpPeers;
	}

	@JsonProperty("bgpPeers")
	public void setBGPPeers(BGPPeer[] value) {
		this.bgpPeers = value;
	}
	...
	public TagsEntities[] getRouteFilterPrefixes() {
		return routeFilterPrefixes;
	}

	@JsonProperty("routeFilterPrefixes")
	public void setRouteFilterPrefixes(TagsEntities[] value) {
