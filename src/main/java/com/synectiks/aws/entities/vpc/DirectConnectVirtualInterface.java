...
public class DirectConnectVirtualInterface implements Serializable{
    ...
    public String getCustomerRouterConfig() { return customerRouterConfig; }
    @JsonProperty("customerRouterConfig")
    public void setCustomerRouterConfig(String value) { this.customerRouterConfig = value; }
    ...
    @JsonProperty("virtualGatewayId")
    public void setVirtualGatewayID(String value) { this.virtualGatewayID = value; }

    @JsonProperty("virtualInterfaceId")
    public String getVirtualInterfaceID() { return virtualInterfaceID; }
    @JsonProperty("virtualInterfaceId")
    public void setVirtualInterfaceID(String value) { this.virtualInterfaceID = value; }

    @JsonProperty("virtualInterfaceName")
    public String getVirtualInterfaceName() { return virtualInterfaceName; }
    @JsonProperty("virtualInterfaceName")
    public void setVirtualInterfaceName(String value) { this.virtualInterfaceName = value; }

    @JsonProperty("virtualInterfaceState")
    public String getVirtualInterfaceState() { return virtualInterfaceState; }
    @JsonProperty("virtualInterfaceState")
    public void setVirtualInterfaceState(String value) { this.virtualInterfaceState = value; }

    @JsonProperty("virtualInterfaceType")
    public String getVirtualInterfaceType() { return virtualInterfaceType; }
    @JsonProperty("virtualInterfaceType")
    public void setVirtualInterfaceType(String value) { this.virtualInterfaceType = value; }
	...
	public String toString() {
		return "DirectConnectVirtualInterface [addressFamily=" + addressFamily + ", amazonAddress=" + amazonAddress
				+ ", asn=" + asn + ", authKey=" + authKey + ", bgpPeers=" + Arrays.toString(bgpPeers)
				+ ", connectionID=" + connectionID + ", customerAddress=" + customerAddress + ", customerRouterConfig="
				+ customerRouterConfig + ", location=" + location + ", ownerAccount=" + ownerAccount
				+ ", routeFilterPrefixes=" + Arrays.toString(routeFilterPrefixes) + ", virtualGatewayID="
				+ virtualGatewayID + ", virtualInterfaceID=" + virtualInterfaceID + ", virtualInterfaceName="
				+ virtualInterfaceName + ", virtualInterfaceState=" + virtualInterfaceState + ", virtualInterfaceType="
				+ virtualInterfaceType + ", vlan=" + vlan + ", externalID=" + externalID + ", connection=" + connection
				+ "]";
	}
}
