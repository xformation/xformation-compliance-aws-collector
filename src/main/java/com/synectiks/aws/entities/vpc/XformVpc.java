...
public class XformVpc implements Serializable{
    ...
    @JsonProperty("subnets")
    public void setSubnets(List<Subnet> value) { this.subnets = value; }
    ...
    public List<TransitGateway> getTransitGateways() { return transitGateways; }
    @JsonProperty("transitGateways")
    public void setTransitGateways(List<TransitGateway> value) { this.transitGateways = value; }

    @JsonProperty("routeTables")
    public List<RouteTable> getRouteTables() { return routeTables; }
    @JsonProperty("routeTables")
    public void setRouteTables(List<RouteTable> value) { this.routeTables = value; }
    ...
    public Boolean getHasFlowLogs() { return hasFlowLogs; }
    @JsonProperty("hasFlowLogs")
    public void setHasFlowLogs(Boolean value) { this.hasFlowLogs = value; }

    @JsonProperty("flowLogs")
    public List<FlowLog> getFlowLogs() { return flowLogs; }
    @JsonProperty("flowLogs")
    public void setFlowLogs(List<FlowLog> value) { this.flowLogs = value; }
