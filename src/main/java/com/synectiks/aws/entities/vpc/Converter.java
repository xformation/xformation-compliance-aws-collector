...
public class Converter {
	...
	public static String toJsonString(XformVpc obj) throws JsonProcessingException {
		return getObjectWriter().writeValueAsString(obj);
	}

	public static String toPrettyJsonString(XformVpc vpc) throws JsonProcessingException {
		return getObjectWriter().with(SerializationFeature.INDENT_OUTPUT).writeValueAsString(vpc);
	}
