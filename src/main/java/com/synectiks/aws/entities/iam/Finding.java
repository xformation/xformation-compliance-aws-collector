...
public class Finding {
    ...
    private List<AttachedGroup> relatedFindingsRef;
    ...
    public List<AttachedGroup> getRelatedFindingsRef() { return relatedFindingsRef; }
    @JsonProperty("relatedFindingsRef")
    public void setRelatedFindingsRef(List<AttachedGroup> value) { this.relatedFindingsRef = value; }
