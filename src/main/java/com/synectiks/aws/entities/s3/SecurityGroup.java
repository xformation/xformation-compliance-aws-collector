...
public class SecurityGroup implements Serializable {
	...
	public List<Document> getInboundPrefixes() {
		return inboundPrefixes;
	}

	@JsonProperty("inboundPrefixes")
	public void setInboundPrefixes(List<Document> value) {
		this.inboundPrefixes = value;
	}

	@JsonProperty("outboundPrefixes")
	public List<Document> getOutboundPrefixes() {
		return outboundPrefixes;
	}

	@JsonProperty("outboundPrefixes")
	public void setOutboundPrefixes(List<Document> value) {
