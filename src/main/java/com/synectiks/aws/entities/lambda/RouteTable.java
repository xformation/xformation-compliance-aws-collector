...
public class RouteTable implements Serializable{
    ...
    private Tags tags;
    private String name;
    private ResourcePolicy tagsEntities;
    ...
    public ResourcePolicy getTagsEntities() { return tagsEntities; }
    @JsonProperty("tagsEntities")
    public void setTagsEntities(ResourcePolicy value) { this.tagsEntities = value; }
	@Override
