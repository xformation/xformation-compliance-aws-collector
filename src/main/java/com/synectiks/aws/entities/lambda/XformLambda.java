...
public class XformLambda implements Serializable{
    ...
    @JsonProperty("handler")
    public void setHandler(String value) { this.handler = value; }

    @JsonProperty("codeSize")
    public String getCodeSize() { return codeSize; }
    @JsonProperty("codeSize")
    public void setCodeSize(String value) { this.codeSize = value; }
    ...
    @JsonProperty("executionRoleArn")
    public void setExecutionRoleArn(String value) { this.executionRoleArn = value; }
    ...
    @JsonProperty("codeSha256")
    public void setCodeSha256(String value) { this.codeSha256 = value; }

    @JsonProperty("kmsKeyArn")
    public String getKmsKeyArn() { return kmsKeyArn; }
    @JsonProperty("kmsKeyArn")
    public void setKmsKeyArn(String value) { this.kmsKeyArn = value; }

    @JsonProperty("deadLetterConfig")
    public DeadLetterConfig getDeadLetterConfig() { return deadLetterConfig; }
    @JsonProperty("deadLetterConfig")
    public void setDeadLetterConfig(DeadLetterConfig value) { this.deadLetterConfig = value; }

    @JsonProperty("tracingConfig")
    public TracingConfig getTracingConfig() { return tracingConfig; }
    @JsonProperty("tracingConfig")
    public void setTracingConfig(TracingConfig value) { this.tracingConfig = value; }

    @JsonProperty("environmentVariables")
    public List<EnvironmentVariable> getEnvironmentVariables() { return environmentVariables; }
    @JsonProperty("environmentVariables")
    public void setEnvironmentVariables(List<EnvironmentVariable> value) { this.environmentVariables = value; }
    ...
    @JsonProperty("executionRole")
    public void setExecutionRole(ExecutionRole value) { this.executionRole = value; }

    @JsonProperty("resourcePolicy")
    public ResourcePolicy getResourcePolicy() { return resourcePolicy; }
    @JsonProperty("resourcePolicy")
    public void setResourcePolicy(ResourcePolicy value) { this.resourcePolicy = value; }
