...
public class NetworkInterface implements Serializable{
    ...
    private List<ResourcePolicy> ipv6Addresses;
    ...
    public List<ResourcePolicy> getIpv6Addresses() { return ipv6Addresses; }
    @JsonProperty("ipv6Addresses")
    public void setIpv6Addresses(List<ResourcePolicy> value) { this.ipv6Addresses = value; }
