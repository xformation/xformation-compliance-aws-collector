...
public class SecurityGroup implements Serializable {
	...
	public List<ResourcePolicy> getInboundPrefixes() {
		return inboundPrefixes;
	}

	@JsonProperty("inboundPrefixes")
	public void setInboundPrefixes(List<ResourcePolicy> value) {
		this.inboundPrefixes = value;
	}

	@JsonProperty("outboundPrefixes")
	public List<ResourcePolicy> getOutboundPrefixes() {
		return outboundPrefixes;
	}

	@JsonProperty("outboundPrefixes")
	public void setOutboundPrefixes(List<ResourcePolicy> value) {
		this.outboundPrefixes = value;
	}

	@JsonProperty("networkAssetsStats")
	public List<NetworkAssetsStat> getNetworkAssetsStats() {
		return networkAssetsStats;
	}

	@JsonProperty("networkAssetsStats")
	public void setNetworkAssetsStats(List<NetworkAssetsStat> value) {
