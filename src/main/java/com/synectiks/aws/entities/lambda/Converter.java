...
//
//     XformLambda data = Converter.fromJsonString(jsonString);
...
public class Converter {
	...
	public static XformLambda fromJsonString(String json) throws IOException {
		return getObjectReader().readValue(json);
	}

	public static String toJsonString(XformLambda obj) throws JsonProcessingException {
	...
	private static void instantiateMapper() {
		...
		reader = mapper.readerFor(XformLambda.class);
		writer = mapper.writerFor(XformLambda.class);
	}
