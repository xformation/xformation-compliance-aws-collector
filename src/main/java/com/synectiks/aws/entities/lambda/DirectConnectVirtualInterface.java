...
public class DirectConnectVirtualInterface implements Serializable{
    ...
    private List<ResourcePolicy> routeFilterPrefixes;
    ...
    public List<ResourcePolicy> getRouteFilterPrefixes() { return routeFilterPrefixes; }
    @JsonProperty("routeFilterPrefixes")
    public void setRouteFilterPrefixes(List<ResourcePolicy> value) { this.routeFilterPrefixes = value; }
