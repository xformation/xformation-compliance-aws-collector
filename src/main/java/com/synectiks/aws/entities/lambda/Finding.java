...
public class Finding implements Serializable{
    ...
    private List<ResourcePolicy> relatedFindingsRef;
    ...
    public List<ResourcePolicy> getRelatedFindingsRef() { return relatedFindingsRef; }
    @JsonProperty("relatedFindingsRef")
    public void setRelatedFindingsRef(List<ResourcePolicy> value) { this.relatedFindingsRef = value; }
