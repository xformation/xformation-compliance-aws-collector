...
public class Bound implements Serializable {
	...
	@JsonProperty("icmpProtocol")
	public void setICMPProtocol(ICMPProtocol value) {
		this.icmpProtocol = value;
	}
	...
	public String getDestinationPortTo() {
		return destinationPortTo;
	}

	@JsonProperty("destinationPortTo")
	public void setDestinationPortTo(String value) {
		this.destinationPortTo = value;
	}
