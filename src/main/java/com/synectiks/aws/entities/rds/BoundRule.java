...
public class BoundRule {
    ...
    @JsonProperty("portTo")
    public void setPortTo(String value) { this.portTo = value; }
    ...
    public ScopeMetaData getScopeMetaData() { return scopeMetaData; }
    @JsonProperty("scopeMetaData")
    public void setScopeMetaData(ScopeMetaData value) { this.scopeMetaData = value; }
