...
public class DirectConnectVirtualInterface {
    ...
    public List<Document> getRouteFilterPrefixes() { return routeFilterPrefixes; }
    @JsonProperty("routeFilterPrefixes")
    public void setRouteFilterPrefixes(List<Document> value) { this.routeFilterPrefixes = value; }
