...
public class XformRDS {
    ...
    @JsonProperty("hostedZoneId")
    public void setHostedZoneID(String value) { this.hostedZoneID = value; }
    ...
    public String getIsStorageEncrypted() { return isStorageEncrypted; }
    @JsonProperty("isStorageEncrypted")
    public void setIsStorageEncrypted(String value) { this.isStorageEncrypted = value; }

    @JsonProperty("storageType")
    public String getStorageType() { return storageType; }
    @JsonProperty("storageType")
    public void setStorageType(String value) { this.storageType = value; }

    @JsonProperty("regionInstance")
    public String getRegionInstance() { return regionInstance; }
    @JsonProperty("regionInstance")
    public void setRegionInstance(String value) { this.regionInstance = value; }
    ...
    @JsonProperty("secondaryAvailabilityZone")
    public void setSecondaryAvailabilityZone(String value) { this.secondaryAvailabilityZone = value; }

    @JsonProperty("isMultiAvailabilityZone")
    public String getIsMultiAvailabilityZone() { return isMultiAvailabilityZone; }
    @JsonProperty("isMultiAvailabilityZone")
    public void setIsMultiAvailabilityZone(String value) { this.isMultiAvailabilityZone = value; }
    ...
    public String getDBClusterName() { return dbClusterName; }
    @JsonProperty("dbClusterName")
    public void setDBClusterName(String value) { this.dbClusterName = value; }
    ...
    public String getAutoMinorVersionUpgrade() { return autoMinorVersionUpgrade; }
    @JsonProperty("autoMinorVersionUpgrade")
    public void setAutoMinorVersionUpgrade(String value) { this.autoMinorVersionUpgrade = value; }

    @JsonProperty("backupRetentionPeriod")
    public String getBackupRetentionPeriod() { return backupRetentionPeriod; }
    @JsonProperty("backupRetentionPeriod")
    public void setBackupRetentionPeriod(String value) { this.backupRetentionPeriod = value; }

    @JsonProperty("engineVersion")
    public String getEngineVersion() { return engineVersion; }
    @JsonProperty("engineVersion")
    public void setEngineVersion(String value) { this.engineVersion = value; }

    @JsonProperty("optionGroups")
    public List<OptionGroup> getOptionGroups() { return optionGroups; }
    @JsonProperty("optionGroups")
    public void setOptionGroups(List<OptionGroup> value) { this.optionGroups = value; }

    @JsonProperty("parameterGroups")
    public List<ParameterGroup> getParameterGroups() { return parameterGroups; }
    @JsonProperty("parameterGroups")
    public void setParameterGroups(List<ParameterGroup> value) { this.parameterGroups = value; }
